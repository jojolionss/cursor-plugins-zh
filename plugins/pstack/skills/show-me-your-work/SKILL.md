...
description: "为长时间运行或无人值守的工作保留可审查的决策轨迹:一份 TSV 日志,每个决策一行(做了什么、为什么、证据、结果)。默认只留在本地;当评审者需要靠这份轨迹来信任结果时才提交。当用户说 /show-me-your-work、『留一份决策日志』『把工作过程摊开给我看』、进行自主或多阶段运行、或工作要等人回来复核时使用。"
