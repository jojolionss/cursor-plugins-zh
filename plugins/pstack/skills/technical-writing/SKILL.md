...
description: "分层的技术写作标准:Diátaxis 文档结构、Google 开发者风格句法、STE 操作指令规则、Global English 语法。当用户说 /technical-writing、『技术写作』,或撰写/评审文档、RFC、README、PR 描述、commit message 时使用。"
