...
description: "Thermo-nuclear 分支审计(bug、破坏性变更、安全、开发体验、feature-flag 泄漏),范围限定在 diff 内。由父代理收集完 diff 与文件内容后经 Task 调用。评审标准加载自 Thermos 插件中的 thermo-nuclear-review 技能。"
---
